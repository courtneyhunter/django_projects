...
from fruits.humanize import naturalsize
...
class CreateForm(forms.ModelForm):
    ...
    class Meta:
        model = Fruit
        fields = ['name', 'message', 'price']  # Picture is manual

    # def clean(self) :f
    #     cleaned_data = super().clean()
    #     fruit = cleaned_data.get('picture')
    #     if fruit is None : return
    #     if len(fruit) > self.max_upload_limit:
